...
public class Maze {
	...
	int height, width;
	private MazeCoords startCoords;
	private MazeCoords endCoords;
	...
	public Maze() {
		...
		startCoords = new MazeCoords(0, 0);
		endCoords = new MazeCoords(width - 1, height - 1);
	}
	
	public int getWidth() { return width; }
	public int getHeight() { return height; }
	public MazeCoords getStartCoords(){
		return startCoords;
	}
	public MazeCoords getEndCoords(){
		return endCoords;
	}
	...
	public boolean isStartSquare(MazeCoords c) {
		return c.x == getStartCoords().x && c.y == getStartCoords().y;//(c.x == 0 && c.y == 0);
	}
	...
	public boolean isEndSquare(MazeCoords c) {
		return c.x == getEndCoords().x && c.y == getEndCoords().y;//(c.x == (width - 1) && c.y == (height - 1));
	}
